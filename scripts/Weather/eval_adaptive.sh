python run.py \
    ...
    --save_folder ./save/Weather_adaptive_eval/text2ts_msmdiffmv \
    ...
    --evaluate_config_path configs/Weather/evaluate_adaptive.yaml \
    --data_folder ./datasets/Weather \
    --clip_folder ./save/Weather_cttp \
    --multipatch_num 3 --L_patch_len 3 --base_patch 1 \
    --batch_size 128 --clip_cache_path ./cache/Weather \
    --only_evaluate true "$@"
